    ...
    <main class="exercise-container">
      ...
      <section class="workout-section" id="workout-section">
        ...
        <div class="workout-cards">
          <div class="workout-card" id="homeWorkout">
            ...
            <a href="#" class="btn-secondary" data-workout="home"
              >View Exercises</a
            >
          </div>
          ...
          <div class="workout-card" id="outdoorWorkout">
            ...
            <a href="#" class="btn-secondary" data-workout="outdoor"
              >View Exercises</a
            >
          </div>
          ...
          <div class="workout-card" id="gymWorkout">
            ...
            <a href="#" class="btn-secondary" data-workout="gym"
              >View Exercises</a
            >
          </div>
        </div>
      ...
      <section class="exercise-details-section" id="exerciseDetails">
        ...
        <div class="exercise-list" id="homeExercises">
          <div class="exercise-item">
            <div class="exercise-img">
              <img src="{{ asset('images/pushup.jpg') }}" alt="Push-ups" />
            </div>
          ...
          <div class="exercise-item">
            <div class="exercise-img">
              <img src="{{ asset('images/squat.jpg') }}" alt="Bodyweight Squats" />
            </div>
            <div class="exercise-info">
          ...
          <div class="exercise-item">
            <div class="exercise-img">
              <img src="{{ asset('images/plank.jpg') }}" alt="Plank" />
            </div>
            <div class="exercise-info">
              <h3>Plank</h3>
              <p>
        ...
        <div class="exercise-list" id="outdoorExercises" style="display: none">
          <div class="exercise-item">
            <div class="exercise-img">
              <img src="{{ asset('images/jogging.jpg') }}" alt="Jogging" />
            </div>
            <div class="exercise-info">
              <h3>Jogging</h3>
              <p>
          ...
          <div class="exercise-item">
            <div class="exercise-img">
              <img src="{{ asset('images/park-bench.jpg') }}" alt="Park Bench Dips" />
            </div>
            <div class="exercise-info">
          ...
          <div class="exercise-item">
            <div class="exercise-img">
              <img src="{{ asset('images/jumping-jacks.jpg') }}" alt="Jumping Jacks" />
            </div>
            <div class="exercise-info">
              <h3>Jumping Jacks</h3>
              <p>
        ...
        <div class="exercise-list" id="gymExercises" style="display: none">
          <div class="exercise-item">
            <div class="exercise-img">
              <img src="{{ asset('images/bench-press.jpg') }}" alt="Bench Press" />
            </div>
            <div class="exercise-info">
              <h3>Bench Press</h3>
              <p>
          ...
          <div class="exercise-item">
            <div class="exercise-img">
              <img src="{{ asset('images/deadlift.jpg') }}" alt="Deadlift" />
            </div>
            <div class="exercise-info">
              <h3>Deadlift</h3>
              <p>
          ...
          <div class="exercise-item">
            <div class="exercise-img">
              <img src="{{ asset('images/lat-pulldown.jpg') }}" alt="Lat Pulldown" />
            </div>
            <div class="exercise-info">
              <h3>Lat Pulldown</h3>
        ...
        <div class="back-to-workout">
          <a href="#workout-section" class="btn-primary" id="backToWorkouts"
            >Choose Another Workout</a
          >
        </div>
      </section>
    </main>
