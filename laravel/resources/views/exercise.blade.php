      ...
      <div class="workout-cards">
        <div class="workout-card" id="homeWorkout">
          <div class="workout-icon">
            <img src="{{ asset('images/home-workout2.jpg') }}" alt="Home Workout" />
          </div>
          <h3>Home Workout</h3>
          <p>
          ...
          <div class="tag-recommended" id="homeRecommended" style="display: none;">
            Recommended for you
          </div>
        ...
        <div class="workout-card" id="outdoorWorkout">
          <div class="workout-icon">
            <img src="{{ asset('images/outdoor-workout.jpg') }}" alt="Outdoor Workout" />
          </div>
          ...
          <div class="tag-recommended" id="outdoorRecommended" style="display: none;">
            Recommended for you
          </div>
        ...
        <div class="workout-card" id="gymWorkout">
          <div class="workout-icon">
            <img src="{{ asset('images/gym-workout.jpg') }}" alt="Gym Workout" />
          </div>
          <h3>Gym Workout</h3>
          <p>
            For experienced users. Full equipment access for maximum results.
          </p>
          <div class="tag-recommended" id="woRecommended" style="display: none;">
            Recommended for you
          </div>
    ...
    <section class="exercise-details-section" id="exerciseDetails">
      ...
      <div class="exercise-list" id="homeExercises">
        ...
        <div class="exercise-item-unw">
          ...
          <div class="exercise-info-unw">
            ...
            <div class="exercise-details">
              ...
              <span>Difficulty: Beginner</span>
              <a href="https://www.youtube.com/watch?v=5NPvv40gd3Q&pp=ygUMd2FsbCBwdXNoIHVw" target="_blank"
                rel="noopener noreferrer" class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-unw">
          ...
          <div class="exercise-info-unw">
            ...
            <div class="exercise-details">
              ...
              <span>Difficulty: Beginner</span>
              <a href="https://www.youtube.com/watch?v=Xp33YgPZgns&pp=ygUMZ2x1dGUgYnJpZGdl" target="_blank"
                rel="noopener noreferrer" class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-std">
          <div class="exercise-img">
            <img src="{{asset('images/workout/home-workout/pushups.gif')}}" alt="Push-ups" />
          </div>
        ...
        <div class="exercise-item-std">
          ...
          <div class="exercise-info-std">
            ...
            <div class="exercise-details">
              <span>3 sets x 15-20 reps</span>
              <span>Difficulty: Beginner</span>
              <a href="https://www.youtube.com/watch?v=m0GcZ24pK6k&pp=ygURYm9keXdlaWdodCBzcXVhdHM%3D" target="_blank"
                rel="noopener noreferrer" class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-std">
          ...
          <div class="exercise-info-std">
            ...
            <div class="exercise-details">
              ...
              <a href="https://www.youtube.com/watch?v=pvIjsG5Svck&pp=ygUFcGxhbms%3D" target="_blank"
                rel="noopener noreferrer" class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-ovw">
          ...
          <div class="exercise-info-ovw">
            ...
            <div class="exercise-details">
              ...
              <span>Difficulty: Beginner</span>
              <a href="https://www.youtube.com/watch?v=wH9hsR7Ck_M&pp=ygUKc3RlcCB0b3VjaA%3D%3D" target="_blank"
                rel="noopener noreferrer" class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-ovw">
          ...
          <div class="exercise-info-ovw">
            ...
            <div class="exercise-details">
              <span>3 sets x 1 min</span>
              <span>Difficulty: Beginner</span>
              <a href="https://www.youtube.com/watch?v=uoRVJBDEX60&pp=ygUMc2VhdGVkIG1hcmNo" target="_blank"
                rel="noopener noreferrer" class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-unw">
          ...
          <div class="exercise-info-unw">
            ...
            <div class="exercise-details">
              ...
              <span>Difficulty: Beginner</span>
              <a href="https://www.youtube.com/watch?v=3qyWpJ34dWw&pp=ygUSZHluYW1pYyBzdHJldGNoaW5n" target="_blank"
                rel="noopener noreferrer" class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-std">
          ...
          <div class="exercise-info-std">
            ...
            <div class="exercise-details">
              <span>20-30 minutes</span>
              <span>Difficulty: Beginner to Advanced</span>
              <a href="https://www.youtube.com/shorts/A5uZobDo80Q" target="_blank" rel="noopener noreferrer"
                class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-std">
          ...
          <div class="exercise-info-std">
            ...
            <div class="exercise-details">
              ...
              <a href="https://www.youtube.com/watch?v=larQGD02ndE&pp=ygUKYmVuY2ggZGlwcw%3D%3D" target="_blank"
                rel="noopener noreferrer" class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-std">
          ...
          <div class="exercise-info-std">
            ...
            <div class="exercise-details">
              ...
              <span>Difficulty: Beginner</span>
              <a href="https://www.youtube.com/watch?v=q_Z29u7nglQ&pp=ygUNanVtcGluZyBqYWNrcw%3D%3D" target="_blank"
                rel="noopener noreferrer" class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-ovw">
          ...
          <div class="exercise-info-ovw">
            ...
            <div class="exercise-details">
              ...
              <span>Difficulty: Beginner to Intermediate</span>
              <a href="https://www.youtube.com/shorts/hmyKV9tUkHc" target="_blank" rel="noopener noreferrer"
                class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-obs">
          ...
          <div class="exercise-info-obs">
            ...
            <div class="exercise-details">
              ...
              <span>Difficulty: Beginner</span>
              <a href="https://www.youtube.com/watch?v=jFM-Hg9V8fM&pp=ygURc2VhdGVkIGFybSByYWlzZXM%3D" target="_blank"
                rel="noopener noreferrer" class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item">
          ...
          <div class="exercise-info">
            ...
            <div class="exercise-details">
              ...
              <span>Difficulty: Beginner</span>
              <a href="https://www.youtube.com/watch?v=vdsaHSr1H_E&pp=ygURdHJlYWRtaWxsIHdhbGtpbmc%3D" target="_blank"
                rel="noopener noreferrer" class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-std">
          ...
          <div class="exercise-info-std">
            ...
            <div class="exercise-details">
              ...
              <span>Difficulty: Intermediate</span>
              <a href="https://www.youtube.com/shorts/hWbUlkb5Ms4" target="_blank" rel="noopener noreferrer"
                class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-std">
          ...
          <div class="exercise-info-std">
            ...
            <div class="exercise-details">
              ...
              <a href="https://www.youtube.com/shorts/HrXR9MxcU8g" target="_blank" rel="noopener noreferrer"
                class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-std">
          ...
          <div class="exercise-info-std">
            ...
            <div class="exercise-details">
              <span>3 sets x 10-15 reps</span>
              <span>Difficulty: Beginner to Intermediate</span>
              <a href="https://www.youtube.com/shorts/4lKxpQvTDvU" target="_blank" rel="noopener noreferrer"
                class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-ovw">
          ...
          <div class="exercise-info-ovw">
            ...
            <div class="exercise-details">
              <span>3 sets x 10-12 reps</span>
              <span>Difficulty: Beginner to Intermediate</span>
              <a href="https://www.youtube.com/shorts/nDh_BlnLCGc" target="_blank" rel="noopener noreferrer"
                class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
        ...
        <div class="exercise-item-obs">
          ...
          <div class="exercise-info-obs">
            ...
            <div class="exercise-details">
              <span>5-10 minutes</span>
              <span>Difficulty: Beginner</span>
              <a href="https://www.youtube.com/watch?v=1iwor0oFjfk&pp=ygUSc3RyZXRjaGluZyBtYWNoaW5l" target="_blank"
                rel="noopener noreferrer" class="exercise-nav-link"> Watch Tutorial </a>
            </div>
          </div>
        </div>
