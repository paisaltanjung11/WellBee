    ...
    <main class="nutrition-container">
      ...
      <section class="nutrition-guide-section">
        ...
        <div class="meal-plan-categories">
          <div class="meal-plan-card" id="balancedDiet">
            ...
            <a href="#" class="btn-secondary" data-meal-plan="balanced"
              >View Plan</a
            >
          </div>
          ...
          <div class="meal-plan-card" id="weightLoss">
            ...
            <a href="#" class="btn-secondary" data-meal-plan="weightLoss"
              >View Plan</a
            >
          </div>
          ...
          <div class="meal-plan-card" id="muscleGain">
            ...
            <a href="#" class="btn-secondary" data-meal-plan="muscleGain"
              >View Plan</a
            >
          </div>
        </div>
      ...
      <section class="meal-plan-details" id="mealPlanDetails">
          ...
          <div class="daily-meals">
            ...
            <div class="meal">
              ...
              <div class="meal-content">
                <div class="meal-image">
                  <img
                    src="{{ asset('images/weight-loss-breakfast.jpg') }}"
                    alt="Weight Loss Breakfast"
                  />
                </div>
                <div class="meal-details">
            ...
            <div class="meal">
              ...
              <div class="meal-content">
                <div class="meal-image">
                  <img
                    src="{{ asset('images/weight-loss-lunch.jpg') }}"
                    alt="Weight Loss Lunch"
                  />
                </div>
                <div class="meal-details">
            ...
            <div class="meal">
              ...
              <div class="meal-content">
                <div class="meal-image">
                  <img
                    src="{{ asset('images/weight-loss-dinner.jpg') }}"
                    alt="Weight Loss Dinner"
                  />
                </div>
                <div class="meal-details">
          ...
          <div class="daily-meals">
            ...
            <div class="meal">
              ...
              <div class="meal-content">
                <div class="meal-image">
                  <img
                    src="{{ asset('images/muscle-gain-breakfast.jpg') }}"
                    alt="Muscle Gain Breakfast"
                  />
                </div>
                <div class="meal-details">
            ...
            <div class="meal">
              ...
              <div class="meal-content">
                <div class="meal-image">
                  <img
                    src="{{ asset('images/muscle-gain-lunch.jpg') }}"
                    alt="Muscle Gain Lunch"
                  />
                </div>
                <div class="meal-details">
            ...
            <div class="meal">
              ...
              <div class="meal-content">
                <div class="meal-image">
                  <img
                    src="{{ asset('images/muscle-gain-dinner.jpg') }}"
                    alt="Muscle Gain Dinner"
                  />
                </div>
                <div class="meal-details">
                  <h5>Recovery Fuel</h5>
        ...
        <div class="back-to-plans">
          <a href="#" class="btn-primary" id="backToPlans"
            >Choose Another Meal Plan</a
          >
        </div>
      </section>
    </main>
