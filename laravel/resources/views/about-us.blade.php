...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="WellBee - Meet our team of dedicated founders and professionals."
    />
      ...
      <section class="mission-story-section">
        <div class="mission-container">
          ...
          <div class="mission-image">
            <img
              src="{{ asset('images/mission-image.png') }}"
              alt="WellBee's mission visualization"
            />
          ...
          <div class="slider-container">
            ...
            <div class="slide">
              ...
              <div class="founder-card">
                ...
                <a
                  href="https://www.linkedin.com/in/brian-casey-reynard"
                  class="connect-btn"
                  target="_blank"
                  >Connect now</a
                >
            ...
            <div class="slide">
              ...
              <div class="founder-card">
                ...
                <a
                  href="https://linkedin.com/in/james"
                  class="connect-btn"
                  target="_blank"
                  >Connect now</a
                >
